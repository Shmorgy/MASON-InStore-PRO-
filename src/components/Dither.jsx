...
void main() {
  ...
  vec3 baseGreen = vec3(0.0, 0.0, 0.0);    // dark green base
  vec3 highlightGreen = vec3(0.1, 0.9, 0.5);           // bright green
  vec3 col = mix(baseGreen, highlightGreen, clamp(f, 0.0, 200.0));
